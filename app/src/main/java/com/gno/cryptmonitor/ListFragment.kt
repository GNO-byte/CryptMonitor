...
class ListFragment : Fragment(), CustomRecyclerAdapter.CellClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tmdbViewModel.popularMoviesLiveData.observe(viewLifecycleOwner, Observer {
           ...
           fragment_list_recyclerview.adapter = CustomRecyclerAdapter(it,this)

        })

    }

    override fun onCellClickListener(index: Int) {
